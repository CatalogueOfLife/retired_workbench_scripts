source /home/GSDS/Master/SQL_templates/GSDS/create_FishBase_buffer_db.sql
...
INSERT INTO `databases` 
 SELECT
 'FishBase'  AS `database_name_displayed`,
 @dbid AS `record_id`,
 'FishBase' AS `database_name`,
 'FishBase' AS `database_full_name`,
  'http://www.fishbase.org' AS `web_site`,
  'FIN; WorldFish; FAO; IFM-GEOMAR; MNHN; RMCA; NRM; FC-UBC; AUTH; CAFS' AS `organization`,
  'R Froese (FishBase Consortium Scientific Coordinator)' AS `contact_person`,
  'Fishes' AS `taxa`,
  'Animalia - Chordata - Actinopterygii, Cephalaspidomorphi, Elasmobranchii, Holocephali, Myxini, Sarcopterygii' AS `taxonomic_coverage`,
