...
if (NR == 1) {print "name_code", "genus", "species", "infraspecies",\
 "infraspecies_marker", "author", "accepted_name_code", "database_id", "family_code","is_accepted_name", "name_status", "reference", "remarks";}
...
sub("\\]$", "", literature);
if (match(species,"x_")) {remarks="Hybrid taxon";}
else {remarks="";}
#sub("x_","x ",genus);
#sub("x_","x ",species);
sub("x_","",genus);
...
print $2"-syn-"i, genus, species, infraspecies, infraspecies_marker, author, $2, 141, family_code, 0, name_status, literature, remarks;}
